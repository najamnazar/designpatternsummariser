...
public class SWUMDemo {
    ...
    private static void testSWUMGrammarParsing() {
        ...
        try {
            swum.grammar.SWUMGrammarParser parser = new swum.grammar.SWUMGrammarParser();
            ...
            for (String methodName : testMethods) {
                swum.model.SWUMStructure structure = parser.parseMethodName(methodName, "TestClass");
